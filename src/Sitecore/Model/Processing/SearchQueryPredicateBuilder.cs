...
namespace Conjunction.Sitecore.Model.Processing
{
  ...
  public class SearchQueryPredicateBuilder<T> : ISearchQueryPredicateBuilder<T> where T : IIndexableEntity, new()
  {
    ...
    {
	    if (searchQueryValueProvider == null) throw new ArgumentNullException(nameof(searchQueryValueProvider));
    ...
    {
	    if (searchQueryGrouping == null) throw new ArgumentNullException(nameof(searchQueryGrouping));
