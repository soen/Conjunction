...
namespace Conjunction.Sitecore.Model.Factories
{
  ...
  public interface ISearchQueryRuleFactory
  {
    ...
    /// </summary>
    /// <typeparam name="T">The type of <see cref="Conjunction.Core.Model.IIndexableEntity"/> implementation to use.</typeparam>
    ...
    SearchQueryRule<T> Create<T>(string associatedPropertyName, string configuredComparisonOperator, string dynamicValueProvidingParameter = null, string defaultValue = null) where T : IIndexableEntity, new();
  }
}